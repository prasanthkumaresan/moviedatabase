    ...
    <div className="nav-maincont">
      <div className="nav-mainel">
        ...
        <div className="max-navcontLink">
          ...
          <Link className="no-link" to="/">
            <h1 className="maxnav-links">Popular</h1>
          </Link>
          <Link className="no-link" to="/top-rated">
            <h1 className="maxnav-links">Top Rated</h1>
          </Link>
          <Link className="no-link" to="/upcoming">
            <h1 className="maxnav-links">Upcoming</h1>
          </Link>
        </div>
      </div>
      {showSearch && (
      ...
      {mobNav && (
        <div className="nav-responsive">
          <Link className="no-link" to="/">
            <h1 className="nav-links">Popular</h1>
          </Link>
          <Link className="no-link" to="/top-rated">
            <h1 className="nav-links">Top Rated</h1>
          </Link>
          <Link className="no-link" to="/upcoming">
            <h1 className="nav-links">Upcoming</h1>
          </Link>
        </div>
      )}
    </div>
